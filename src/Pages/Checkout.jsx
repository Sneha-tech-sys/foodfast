...
export default function Checkout() {
  ...
  return (
    <div style={backgroundStyle}>
      ...
      <button class="btn btn send-button" id="submit" type="submit" value="SEND" style={{backgroundColor:'transparent',color:'white',border:'1px solid lightgray'}}>
